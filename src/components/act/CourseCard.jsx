  ...
  const accordionItems = [
    {
      ...
      bg: "rgba(231, 246, 255, 1)",
      mobileBg: "linear-gradient(135deg, #E3F2FD, #BBDEFB)",
    },
    {
      title: "PERSONALIZED BESPOKE TUTORING FOR MYP",
      bg: "rgba(214, 235, 252, 1)",
      mobileBg: "linear-gradient(135deg, #E3F2FD, #BBDEFB)",
    },
    {
      title: "PERSONALIZED BESPOKE TUTORING FOR MYP",
      bg: "rgba(197, 224, 250, 1)",
      mobileBg: "linear-gradient(135deg, #E3F2FD, #BBDEFB)",
    },
    {
      title: "PERSONALIZED BESPOKE TUTORING FOR MYP",
      bg: "rgba(180, 213, 248, 1)",
      mobileBg: "linear-gradient(135deg, #E3F2FD, #BBDEFB)",
    },
    {
      title: "PERSONALIZED BESPOKE TUTORING FOR MYP",
      bg: "rgba(163, 202, 245, 1)",
      mobileBg: "linear-gradient(135deg, #E3F2FD, #BBDEFB)",
    },
  ];
      ...
      <div className="py-5 px-3 fade-in-section desktop-version">
        <div className="container" style={{ maxWidth: "74.166vw" }}>
          ...
          <div className="text-center mb-5 fade-in-section">
            <div className="d-flex align-items-center justify-content-center mb-3 gap-3 fade-in-section">
              <h1
                  ...
                  >
                    <div className="row g-4">
                      ...
                      <div className="col-md-6">
                        ...
                        <h5 className="fw-bold mb-3" style={{ fontSize: "1rem", color: "#2D5AA0" }}>
                          KEY HIGHLIGHTS
                        </h5>
