      ...
      >
        ...
        <div className="position-relative h-100" style={{ zIndex: 1 }}>
          <div className="row g-0 h-100">
            {/* Left Section */}
            <div className="col-lg-7 d-flex flex-column justify-content-center pe-lg-4 p-4">
              <h1
              ...
              >
                ADVANCED PLACEMENTS TUTORS  <br /> IN DUBAI
              </h1>

              <p
                className="text-white fw-bold mb-4 fade-in-section fs-6 fs-md-5"
                data-scroll
                data-scroll-class="is-inview"
                data-scroll-repeat
                style={{ letterSpacing: "0.1em", opacity: "0.8", animationDelay: "0.25s" }}
              >
                NEW AP BATCHES STARTS 
                <br/>FROM 22ND AUGUST, 2025
                              </p>
...
.position-relative.overflow-hidden::before {
  ...
  z-index: 1;
          ...
          /* Mobile content layout - single column */
          .row.g-0.h-100.p-4 {
          ...
          /* Mobile info row - horizontal layout like in image */
          .info-row {
