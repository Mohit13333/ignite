            ...
            <div className="container fade-in-section"
                ...
                <div className="curriculumSubSection" style={{ padding: '30px 0', marginBottom: '3rem' }}>
                    <h3
                        ...
                        className="fade-in-section SubHeading curriculumSubHeading"
                    ...
                    <h2
                        ...
                        data-scroll-class="is-inview"
                        data-scroll-repeat="true"
                        className="fade-in-section curriculumTitle"
                    ...
                    <h2
                        ...
                        data-scroll-class="is-inview"
                        data-scroll-repeat="true"
                        className="fade-in-section curriculumSubtitle"
                        style={{ margin: "8px 0 0 0", animationDelay: "0.35s" }}
                    >
                        SUPPORTED <span className="curriculumHighlight">BY IGNITE</span>
                    </h2>
                </div>
            </div>
