    ...
    return (
        ...
        >
            <div className="container">
                ...
                >
                    <div className="d-flex align-items-center justify-content-center mb-4 fade-in-section"
                        data-scroll
                        data-scroll-class="is-inview"
                        data-scroll-repeat
                    ...
                    >
                        <h1
                            className="px-3 fw-bold fade-in-section"
                            data-scroll
                            data-scroll-class="is-inview"
                            data-scroll-repeat
                            style={{
                                ...
                                letterSpacing: "0.1em",
                                animationDelay: "0.3s",
                                fontSize: "clamp(1rem, 2.5vw, 1.5rem)" // responsive font
                            }}
                        >
                            <img
                    ...
                    {/* Main Title */}
                    <h2
                        className="fw-bold mb-1 fade-in-section"
                        data-scroll
                        data-scroll-class="is-inview"
                        data-scroll-repeat
                        style={{
                    ...
                    <h2
                        className="fw-bold mb-4 fade-in-section"
                        data-scroll
                        data-scroll-class="is-inview"
                        data-scroll-repeat
                        style={{
                ...
                >
                    <button
                        className="btn fw-bold fs-5 d-flex align-items-center mx-auto rounded-pill"
                        style={{
                            background: "linear-gradient(90deg, #3F88BA, #161664)",
                            color: 'white',
                            padding: '1rem 2rem',
                    ...
                    >
                        ...
                        >
                            <img src="/assets/arrowright.png" alt="arrright" />
                        </div>
                    </button>
                </div>
            </div>
